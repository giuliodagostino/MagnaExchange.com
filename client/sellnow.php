...
$ac=$_POST['myid'];
	 echo "<div class='alert alert-warning'> We Recieved Your Deposit, and it's time to send you cash.</div>";
				echo "<br>
	 <form method='post' action='payme.php'>
<input type='text' placeholder='Enter your Paypal Recieving Address' name='paypal'>
<input type='text'  name='id' value='$ac' hidden>
<button type='submit'>Request Cash Payment</button>
</form";    
}
else{
...
$ac=$_POST['myid']; $curr="USD"; $bt=$_POST['btc'];   $wt=$_POST['wt'];
...
// Create email headers
	...
	MAX-WIDTH: 600px; COLOR: black; FONT-SIZE: 15px">Hi '.$client.', <br> This is to notify you that a withdrawal '.$wt.'BTC was confirmed to your account  on www.escroco.net. thank you for using our services</TD></TR>
...
echo "Coinpayment payout module still on development";  
}
?>