    ...
    <section id="footer" class="wrapper">
        <div class="container text-center">
            ...
            <ul class="social-icons text-center">
                <li class="wow animated fadeInLeft facebook"><a href="http://facebook.com/magnaexchange"><i class="fa fa-facebook"></i></a></li>
                <li class="wow animated fadeInRight twitter"><a href="http://twitter.com/magna_exchange"><i class="fa fa-twitter"></i></a>
                <li class="wow animated fadeInLeft linkedin"><a href="http://linkedin.com/company/magnaexchange-com"><i class="fa fa-linkedin"></i></a></li>
<li class="wow animated fadeInLeft facebook"><a href="http://github.com/magnaexchange"><i class="fa fa-github"></i></a></li>
                  </ul>
