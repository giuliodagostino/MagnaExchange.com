				    ...
				    <div class="col-lg-12 col-md-12">
							<div class="card">
	                            <div class="card-header" data-background-color="purple">
    	                                <h4 class="title">SELLERS PAYMENT REQUEST </h4>
	                                <p class="category">Lists of requests for sellers payments </p>
	                            </div>
	                            <div class="card-content table-responsive">
	                                <table class="table table-hover">
	                                    <thead class="text-info">
	                                        <th>User</th><th>Amount</th>
											<th>Coin</th><th>Activity</th>
	                                    	<th>Status</th>
	                                    	<th>Date</th> 
	                                    	<th>Options</th>
	                                    </thead>
	                                    <?php 
$query="SELECT * FROM account  WHERE sell=1";
